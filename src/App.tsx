      ...
      <div className="min-h-dvh bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans px-4">
        <div className="sm:mx-auto sm:w-full sm:max-w-md flex flex-col items-center">
          ...
          <h2 className="text-center text-3xl font-black tracking-tight text-slate-800">
            {isSignUp ? 'Create your LinkVault' : 'Welcome back'}
          </h2>
          <p className="mt-2 text-center text-sm text-slate-500 font-medium max-w-xs">
            {isSignUp 
              ...
              : 'Sign in to access your saved links and sync across devices.'}
          </p>
        </div>

        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 rounded-2xl border border-slate-200/80 sm:px-10">
            <form onSubmit={handleAuth} className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest ml-1 mb-1">
                  Email Address
                </label>
                <input
                  type="email"
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all font-medium text-slate-800"
              ...
              {authError && (
                <div className="text-rose-500 text-xs font-semibold bg-rose-50 p-3.5 rounded-xl border border-rose-100 flex items-start gap-2.5">
              ...
              <button
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md shadow-indigo-100 active:scale-[0.98] disabled:opacity-50"
              >
                {loadingAuthAction ? (
            ...
            <div className="mt-6 flex justify-center text-xs">
              <button
                ...
                className="font-bold text-indigo-600 hover:text-indigo-500 transition-colors uppercase tracking-wider animate-none"
              >
